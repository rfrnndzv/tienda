    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="" disabled="true" wire:model="fecha"/>
            </div>
            ...
            <div class="mb-4" wire:ignore>
                ...
                <select class="js-example-basic-single" wire:model="producto_id" style="width: 100%">
                    ...
                    @foreach ($productos as $producto)
                        <option value="{{ $producto->id }}">{{ $producto->nombre . ' - Bs. ' . $producto->tarifa[$producto->tarifa->count()-1]->venta}}</option>
                    @endforeach
                </select>
